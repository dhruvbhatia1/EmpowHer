		...
		<div className="home-container">
			...
			<section id="features" className="features-section">
				...
				<div className="feature-card">
					...
					<p>
						Track your menstrual cycle with precision and receive notifications
						for upcoming periods and fertile windows.
					</p>
				</div>
				<div className="feature-card">
					<img
				...
				<div className="feature-card">
					...
					<p>
						Receive personalized tips, exercises, and self-care recommendations
						based on your menstrual health data.
					</p>
				</div>
			</section>
